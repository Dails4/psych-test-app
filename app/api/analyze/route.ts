...
9. suggestedReplies (Как ответить): Дай 3 варианта ответа на ПОСЛЕДНЮЮ реплику [Партнер]. Стили: "Мягкий", "Жесткий", "Дипломатичный".
...
export async function POST(req: Request) {
  try {
    ...
    // Читаем текст переписки из Upstash
    ...
    // Лимит: 10 000 символов для бесплатных юзеров
